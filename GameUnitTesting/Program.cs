  ...
  class MainClass
  {
    ...
    public static void Main(string[] args)
    {
      ...
      try {
        ...
        var stakan = new Fill(40, 10, 10, 20, Color.Gray, Registry<GraphicsFactory>.GetInstanceOf<ConsoleGraphicsFactory>().CreateFillImplementation);
        mesh.AddUnit(stakan);
        ...
        mesh.AddUnit(new Cell(80, 10, Color.Gray, Registry<GraphicsFactory>.GetInstanceOf<ConsoleGraphicsFactory>().CreateFillImplementation));
        mesh.AddUnit(new Cell(70, 10, Color.Gray, Registry<GraphicsFactory>.GetInstanceOf<ConsoleGraphicsFactory>().CreateCellImplementation));
